...
const en = {
  badge: 'Demo assistant', title: 'Who could help you move forward?', intro: 'Tell me what you are working on. Suggestions use scripted topic matching and real directory profiles.',
  ...
  results: 'These demo suggestions share the profile details shown below. Availability and request limits are checked again when you send.',
  empty: 'No available profile matched this scripted topic. Try another skill or browse the directory.',
  ...
  proposedTime: 'Proposed time', flexibleDraft: 'We can agree on a time together.', emptyDraft: 'Enter the message you want to send.', close: 'Close',
};
const it = {
  badge: 'Assistente demo', title: 'Chi potrebbe aiutarti a fare un passo avanti?', intro: 'Racconta su cosa stai lavorando. I suggerimenti usano temi predefiniti e profili reali della directory.',
  ...
  results: 'Questi suggerimenti demo si basano sui dettagli dei profili mostrati. Disponibilita e limiti saranno ricontrollati quando invii.',
  empty: 'Nessun profilo disponibile corrisponde a questo tema predefinito. Prova una competenza diversa o sfoglia la directory.',
  ...
  proposedTime: 'Orario proposto', flexibleDraft: 'Possiamo concordare insieme un orario.', emptyDraft: 'Inserisci il messaggio da inviare.', close: 'Chiudi',
};
const fr = {
  badge: 'Assistant de demonstration', title: 'Qui pourrait vous aider a avancer ?', intro: 'Expliquez votre besoin. Les suggestions utilisent des themes predefinis et les profils reels du repertoire.',
  ...
  results: 'Ces suggestions de demonstration reposent sur les details affiches. La disponibilite et les limites seront verifiees lors de l envoi.',
  empty: 'Aucun profil disponible ne correspond a ce theme predefini. Essayez une autre competence ou parcourez le repertoire.',
  ...
  proposedTime: 'Horaire propose', flexibleDraft: 'Nous pouvons convenir ensemble d un horaire.', emptyDraft: 'Saisissez le message a envoyer.', close: 'Fermer',
};
